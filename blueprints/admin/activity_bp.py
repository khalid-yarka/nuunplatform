# blueprints/admin_activity_bp.py
# ============================================================
# Admin activity feed — reads from the activity_logs table.
#
# Routes:
#   GET /admin/activity/         → the feed page
#   GET /admin/activity/feed     → JSON API used by the page
# ============================================================
...
@admin_required
def index():
    return render_template('dashboard/admin/ops/activity.html')
...
def feed():
    ...
    types_cursor = execute_with_retry(
